...
<head>
    ...
    <title>Tambah Matakuliah - Nura Akademik</title>
                ...
                <div class="max-w-md w-full">
                    <div class="main-card shadow-sm overflow-hidden">
                        <div class="p-6 border-b border-[#f0f2f5] bg-[#fcfdfe]">
                            <h1 class="text-[18px] font-bold text-[#1a2540]">Tambah Matakuliah</h1>
                            <p class="text-[13px] text-[#8a96a6] mt-0.5">Input data kurikulum baru ke sistem.</p>
                        </div>
                        ...
                        <form action="{{ route('matakuliah.store') }}" method="POST" class="p-6 space-y-5">
                            ...
                            {{-- Select Jurusan --}}
                            <div>
                                <label class="block text-[13px] font-bold text-[#3a4a5c] mb-2">Jurusan Terkait</label>
                                <div class="relative">
                                    <i
