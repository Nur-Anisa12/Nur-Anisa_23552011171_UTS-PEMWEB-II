...
<head>
    ...
    <title>Tambah Jurusan - Nura Akademik</title>
    ...
    <div class="flex min-h-screen">
        ...
        <main class="flex-1 flex flex-col min-w-0">
            ...
            <header class="topbar h-14 flex items-center justify-between px-6 flex-shrink-0">
                ...
                {{-- Button Kembali di Pojok Navbar --}}
                <a href="/jurusan"
                ...
                <div class="max-w-md w-full">
                    ...
                    <div class="main-card shadow-sm overflow-hidden">
                        <div class="p-6 border-b border-[#f0f2f5] bg-[#fcfdfe]">
                            <h1 class="text-[18px] font-bold text-[#1a2540]">Tambah Jurusan</h1>
                            <p class="text-[13px] text-[#8a96a6] mt-0.5">Lengkapi formulir untuk menambah program studi.
                            </p>
                        </div>
                    ...
                    <div class="mt-8 p-4 rounded-xl border border-dashed border-[#e5e9ef] bg-white/50">
                        <div class="flex gap-3">
                            ...
                            <p class="text-[12px] text-[#718096] leading-relaxed">
                                <strong>Info:</strong> Data yang baru ditambahkan akan langsung muncul pada daftar
